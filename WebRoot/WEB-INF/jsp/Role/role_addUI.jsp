    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="roleAction_add.action" method="post" id="myform" name="myform" >
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>角色名</th>
                                <td>
                                    <input id = "name" class="common-text required" id="title" name="role.name" size="50" value="" type="text">
                                </td>
                            </tr>
