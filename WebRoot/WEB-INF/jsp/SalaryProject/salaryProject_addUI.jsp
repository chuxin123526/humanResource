    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="salaryProjectAction_add.action" method="post" id="myform" name="myform" >
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>薪酬项目名称</th>
                                <td>
                                    <input id = "name" class="common-text required" id="title" name="salaryProject.name" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>金额</th>
                                <td>
                                    <input id = "money" class="common-text required" id="title" name="salaryProject.money" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th></th>
