    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="userAction_update.action" method="post" id="myform" name="myform" >
                    <table class="insert-tab" width="100%">
                        ...
                        <s:hidden name="user.id"></s:hidden>
                            <tr>
                                ...
                                <td>
                                <input id = "name" class="common-text required" id="title" name="user.name" size="50" value="${user.name}" type="text">
