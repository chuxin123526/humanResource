    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="organazationAction_add.action" method="post" id="myform" name="myform" >
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>机构名称</th>
                                <td>
                                    <input id = "organazation" class="common-text required" id="title" name="organazation.name" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                <input type="text" name = "organazation.description" size = "50"/>
                                </textarea>
                                </td>
                            </tr>
                            <tr>
