...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action = "salaryStandardApproveAction_approve.action" method="post">
       ...
       <tr>
       <td align = "center">审核意见:　</td><td colspan="5"><textarea rows="5" cols="101" name = "salaryStandard.approveIdea"></textarea></td>
       </tr>
       </table>
                ...
                <div class="result-content">
                    ...
                    <div class="list-page"> <input class="btn btn-primary btn6 mr10" value="提交" type="submit">
                                    <input class="btn btn6" onclick="history.go(-1)" value="返回" type="button"></div>
                </div>
