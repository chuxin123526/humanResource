    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="positionTitleAction_update.action" method="post" id="myform" name="myform" >
                    <table class="insert-tab" width="100%">
                        <tbody>
                       		 <s:hidden name = "positionTitle.id"></s:hidden>
                            <tr>
                                <th><i class="require-red">*</i>职称名称</th>
                                <td>
                                    <input id = "name" class="common-text required" id="title" name="positionTitle.name" size="50" value="${positionTitle.name}" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>职位</th>
                                <td>
                                	<select class="common-text required" name = "positionID" style="width:440px;height:30px">
                                	<option value = "0">无</option>
                                	<s:iterator value="#positionList">	
	                                	<s:if test="%{#positionTitle.position.id==id}">
                            ...
                            <tr>
                                ...
                                <td>
                                <input type="text" name = "positionTitle.description" value = "${positionTitle.description}" size = "50"/>
