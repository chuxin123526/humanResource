    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="positionAction_add.action" method="post" id="myform" name="myform" >
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>职位名称</th>
                                <td>
                                    <input id = "name" class="common-text required" id="title" name="position.name" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>职位类型</th>
                                <td>
                                	<select class="common-text required" name = "positionTypeID
                            ...
                            <tr>
                                ...
                                <td>
                                <input type="text" name = "position.description" size = "50"/>
                                </td>
                            </tr>
                            <tr>
                                <th></th>
